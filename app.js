...
const PIN_ALTITUDE = 0.009;
const TRACK_ALTITUDE = 0.008;
const TRACK_LINE_WIDTH = 2;
const TORNADO_TRACK_LINE_WIDTH = 1;
const PIN_RADIUS = 0.0036;
const PIN_HIT_SCALE = 3.6;
const PIN_RADIUS_TSUNAMI = 0.0046;
const PIN_TSUNAMI_HALO_SCALE = 1.28;
const PIN_SEGMENTS = 24;
const PIN_TORNADO_CORE_RATIO = 0.6;
